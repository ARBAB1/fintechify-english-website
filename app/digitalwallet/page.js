...
import img1 from "../components/assets/images/dw1.png";
  ...
  const list = [
    {
        ...
        desc: "Enables users to make secure, instant payments both online (via FT, IBFT, Top-up, QR code scanning).",
    },
    {
        id: 2,
        title: "User Authentication",
        desc: "Provides multi-factor authentication (e.g., PIN, biometrics) for secure access and transaction approval, ensuring that only authorized users can access funds.",
    },
    {
        id: 2,
        ...
        desc: "Keeps a record of all transactions made, which helps users track spending and manage finances effectively.",
    },   {
        id: 2,
        title: "Payments and Transfers",
        desc: "Enables users to send or receive money easily to/from other users.",
    },   {
        id: 2,
        title: "Real-Time Notifications",
        desc: "Sends alerts and notifications for transactions, balances, or offers, helping users stay informed and engaged with their wallet activity.",
    },
      ...
      <section className="mb-5 mt-5 d-lg-block d-none">
        <div className="container-fluid px-lg-5">
          <ProjectIntroduction
            title={"Overview"}
            desc={
"A Digital Wallet is a secure electronic application or software that allows users to store and manage their payments such as debit cards, bill payments, fund transfer to make online payments seamlessly"
            }
          />
          <ProjectIntroduction
            title={"Target Audience"}
            desc={
              "Banks, Non-banking Financial Institutions, E-commerce platforms, Telcos"
            }
          />
