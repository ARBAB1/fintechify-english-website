          ...
          <li>
            ...
            {isDropdownOpen && (
              <ul className={styles.dropdown}>
                ...
                <li>
                  <Link href="/solution-re-engineering">Solution Re-Engineering</Link>
                </li>
                <li>
                  <Link href="/DevOps-Transformation">DevOps Transformation</Link>
                </li>
                <li>
          ...
          <li>
            ...
            {isDropdownOpentwo && (
              <ul className={styles.dropdown}>
                ...
                <li>
                  <Link href="/FinBloc">FinBloc</Link>
                </li>
              </ul>
            )}
          </li>
