...
function page() {
  const list = [
    {
        id: 1,
        title: "Digital KYC and Customer Onboarding",
      ...
      <section className="mb-5 mt-5 d-lg-block d-none">
        <div className="container-fluid px-lg-5">
          <ProjectIntroduction
            title={"Overview"}
            desc={
"A Digital Bank is an online financial institution offering seamless banking services without relying on physical branches like account management, transfers, and investments via secure digital platforms, leveraging technology for efficiency, personalization, and regulatory compliance."
            }
          />
          <ProjectIntroduction
